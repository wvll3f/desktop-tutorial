...
function Header() {
  ...
  return (
    <UserStorage>
      <div className='bg-blue w-full flex flex-row items-center justify-between px-4 font-bold text-gray-200 bg-gray-900 h-16'>
        ...
        {data.username !== 'Login/Criar' ?
          <Link className='flex p-3 gap-2 justify-center font-bold text-gray-200' to='/'>
            ...
            {data.username}
            <LogOut className='w-4' onClick={logout} to='/login'/>
          </Link>
          :
